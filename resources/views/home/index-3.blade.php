                        ...
                        <div class="ltn__category-menu-toggle ltn__one-line-active">
                            <ul>
                                ...
                                <li class="ltn__category-menu-item ltn__category-menu-drop">
                                    <a href="shop.html"><i class="icon-shopping-bags"></i>Health Care </a>
                                ...
                                <!-- Submenu Column - 4 -->
                                <li class="ltn__category-menu-item ltn__category-menu-drop">
                                    <a href="shop.html"><i class="icon-options"></i>First Aid </a>
                                ...
                                <!-- Submenu Column - 3 -->
                                <li class="ltn__category-menu-item ltn__category-menu-drop">
                                    <a href="shop.html"><i class="icon-award"></i>Surgical Product</a>
                                ...
                                <!-- Submenu Column - 2 -->
                                <li class="ltn__category-menu-item ltn__category-menu-drop">
                                    <a href="shop.html"><i class="icon-user"></i>Diagnostic Product</a>
                                ...
                                <!-- Submenu -->
                                <li class="ltn__category-menu-item ltn__category-menu-drop">
                                    <a href="shop.html"><i class="icon-shopping-cart"></i>Laboratory Product</a>
                                ...
                                <!-- Submenu -->
                                <li class="ltn__category-menu-item ltn__category-menu-drop">
                                    <a href="shop.html"><i class="icon-tag"></i>Hospital Products</a>
                                    <ul class="ltn__category-submenu">
                                        <li class="ltn__category-submenu-title ltn__category-menu-drop"><a href="#">Handbags</a>
                                            <ul class="ltn__category-submenu-children">
                                                <li><a href="#">Clutches</a></li>
                                ...
                                <!-- Submenu -->
                                <li class="ltn__category-menu-item ltn__category-menu-drop">
                                    <a href="shop.html"><i class="icon-shopping-bags"></i>Service & Setup </a>
                                    <ul class="ltn__category-submenu">
                                        <li class="ltn__category-submenu-title ltn__category-menu-drop"><a href="#">Handbags</a>
                                            <ul class="ltn__category-submenu-children">
                                                <li><a href="#">Clutches</a></li>
                                ...
                                <!-- Submenu -->
                                <li class="ltn__category-menu-item ltn__category-menu-drop">
                                    <a href="shop.html"><i class="icon-options"></i>Food & Nutrition</a>
                                    <ul class="ltn__category-submenu">
                                        <li class="ltn__category-submenu-title ltn__category-menu-drop"><a href="#">Handbags</a>
                                            <ul class="ltn__category-submenu-children">
                                                <li><a href="#">Clutches</a></li>
                            ...
                            <div class="ltn__product-tab-content-inner">
                                <div class="row ltn__tab-product-slider-one-active slick-arrow-1">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            <div class="product-img">
                                                <a href="product-details.html"><img src="img/product-2/11.png" alt="#"></a>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            <div class="product-img">
                                                <a href="product-details.html"><img src="img/product-2/12.png" alt="#"></a>
                                                <div class="product-badge">
                                                    <ul>
                                                        <li class="sale-badge">-19%</li>
                                                    </ul>
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-md-6 col-sm-8">
                    <div class="call-to-action-inner text-color-white--- text-center---">
                        ...
                        <div class="ltn__countdown ltn__countdown-3 bg-white--" data-countdown="2023/11/28"></div>
                        <div class="btn-wrapper animated">
                            <a href="shop.html" class="theme-btn-1 btn btn-effect-1 text-uppercase">Shop now</a>
